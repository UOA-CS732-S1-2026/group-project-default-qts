...
const bcrypt = require('bcryptjs'); // for password compare + hash
...
/**
 * PATCH /api/users/me
 * Body: { name?, username?, petName? }
 * - name/username updates User.name (frontend uses "username")
 * - petName updates active pet nickname
 */
...
router.patch('/me/password', requireAuth, async (req, res) => {
  try {
    ...
    user.passwordHash = String(newPassword); // will be hashed by pre-save hook
    await user.save();
