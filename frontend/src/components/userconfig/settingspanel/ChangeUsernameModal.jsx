...
export default function ChangeUsernameModal({ onClose }) {
    ...
    function handleSubmit(e) {
        ...
        const res = updateUsername(newUsername.trim());
            ...
            {success ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 8 }}>
                    ...
                    <div className="field-group">
                        ...
                        <input id="new-username" type="text" className={`gf-input${error ? ' error' : ''}`}
                            placeholder="At least 3 characters" value={newUsername}
