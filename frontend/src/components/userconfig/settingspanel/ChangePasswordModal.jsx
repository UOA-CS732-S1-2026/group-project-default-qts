...
export default function ChangePasswordModal({ onClose }) {
    ...
    function setF(key, val) { setForm((p) => ({ ...p, [key]: val })); setErrors((p) => ({ ...p, [key]: '' })); }
    ...
    function handleSubmit(e) {
        ...
        const res = updatePassword(form.current, form.newPw);
            ...
            {success ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 8 }}>
                    <div className="field-group">
                        ...
                        <input id="cp-current" type="password" className={`gf-input${errors.current ? ' error' : ''}`}
                    ...
                    <div className="field-group">
                        ...
                        <input id="cp-new" type="password" className={`gf-input${errors.newPw ? ' error' : ''}`}
                            placeholder="Create new password" value={form.newPw}
                    ...
                    <div className="field-group">
                        ...
                        <input id="cp-confirm" type="password" className={`gf-input${errors.confirm ? ' error' : ''}`}
                            placeholder="Re-enter new password" value={form.confirm}
